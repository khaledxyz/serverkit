/**
 * Timezone identifiers based on the IANA Time Zone Database
 * @see https://en.wikipedia.org/wiki/List_of_tz_database_time_zones
 */

// Type definition for timezone strings
...
// Raw timezone identifiers array
export const TIMEZONES: readonly TimezoneId[] = [
  "Africa/Abidjan",
  "Africa/Accra",
  "Africa/Addis_Ababa",
  "Africa/Algiers",
...
/**
 * Search timezones by city name (case-insensitive)
 */
 ...
 */
export function isValidTimezone(timezoneId: string): timezoneId is TimezoneId {
  return TIMEZONES.includes(timezoneId as TimezoneId);
}
